...
## Corpus Check
- 110 files · ~94,723 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 734 nodes · 1371 edges · 43 communities (40 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ec30dbbd`
...
Cohesion: 0.15
Nodes (19): HumanoidLook, NpcModal(), Script, scriptFor(), activeQuestInfo(), NpcDef, NpcId, NPCS (+11 more)
...
Cohesion: 0.07
Nodes (39): HumanoidFigure(), HumanoidPose, useLookAssets(), SPAWN, DialogueLine, setDialogue(), ArsipRack(), GHOST_SLICES (+31 more)
...
Cohesion: 0.12
Nodes (29): questEvent(), addAchievement(), addToast(), beginNightShift(), cancelPurge(), completePurge(), DoorId, emit() (+21 more)
...
Cohesion: 0.11
Nodes (26): DoorGate(), ExploreWorld(), HIRE_STATION, HOUSE_LIGHT_BASE, STATUS_STATION, wallCenter(), Hologram(), BENGKEL (+18 more)
...
Cohesion: 0.12
Nodes (18): FirstPersonArms(), Gait, OPERATOR_LOOK, ThirdPersonBody(), blocked(), slideMove(), WallRect, HELD_KEYS (+10 more)
...
Cohesion: 0.16
Nodes (10): buildNetwork(), Cables(), ceilingRun(), floorRun(), makeTube(), TRUNK_X, CORRIDOR, SIDE_X (+2 more)
...
Cohesion: 0.16
Nodes (17): projectBySlug(), LoginModal(), Auth, authRequest(), connectPresence(), disconnectPresence(), handleRoster(), loadAuth() (+9 more)

### Community 26 - "Community 26"
Cohesion: 0.20
Nodes (9): PlayerRig(), corridorEndZ(), endMargin(), progressToZ(), RoomCameraRig(), useActiveStation(), RoomHUD(), scrollTopFor() (+1 more)
...
Cohesion: 0.20
Nodes (8): OnlinePlayers(), PEER_LOOK, useExplore(), BANNER, HELP, Line, TerminalModal(), NightShift()
...
Cohesion: 0.17
Nodes (9): ExploreHud(), buildExploreMap(), Minimap(), WINDS, peerState, beginSession(), resetPlayer(), RoomCanvas (+1 more)
...
Cohesion: 0.16
Nodes (10): downloadCertificate(), SERVICE_RACKS, ServiceRacks(), TwinPayload, UpMap, Wallboard(), WallNote, PALETTE (+2 more)
...
- **Why does `site` connect `Community 19` to `Community 27`, `Community 35`, `Community 14`, `Community 6`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `PALETTE` connect `Community 44` to `Community 2`, `Community 35`, `Community 36`, `Community 40`, `Community 8`, `Community 43`, `Community 18`, `Community 21`, `Community 23`, `Community 25`, `Community 26`, `Community 27`?**
